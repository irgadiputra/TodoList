    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield prisma_1.default.$transaction((t) => __awaiter(this, void 0, void 0, function* () {
                ...
                const hashedPassword = yield (0, bcryptjs_1.hash)(param.password, salt);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (param.new_password) {
                ...
                const isMatch = yield (0, bcryptjs_1.compare)(param.old_password, user.password);
                if (!isMatch) {
                    throw new Error("Old password is incorrect");
                }
                const salt = (0, bcryptjs_1.genSaltSync)(10);
                const hashedNewPassword = yield (0, bcryptjs_1.hash)(param.new_password, salt);
...
function SendVerifyEmailService(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const user = yield prisma_1.default.user.findUnique({
                where: { id: id },
            ...
            const templateSource = fs_1.default.readFileSync(templatePath, "utf-8");
            const compiledTemplate = handlebars_1.default.compile(templateSource);
            const html = compiledTemplate({ email: user.email, fe_url: `${config_1.FE_URL}/auth/verify-email?token=${token}` });
            yield nodemailer_1.Transporter.sendMail({
                from: "LoketKita",
                to: user.email,
                subject: "Welcome",
